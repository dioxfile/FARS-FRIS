...
* Step 3 - Enter the new FOLDER, EX: "cd FOLDER", and give execution permission to the run.sh, INSTALL.sh, and octave.m files, EX: "chmod +x run.sh INSTALL.sh octave.m"; 
